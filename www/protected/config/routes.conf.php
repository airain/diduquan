...
$route['*']['/index'] = array('IndexController', 'index');
$route['*']['/error'] = array('ErrorController', 'index');
$route['*']['/admin'] = array('redirect', '/admin/main');
$route['*']['/email/unsubscribe/:email/:code'] = array('EmailController', 'unsubscribe');




//---------- Delete if not needed ------------
$admin = array('huxf'=>'20053932');
