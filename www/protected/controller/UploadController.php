...
class UploadController extends BaseController{
    ...
    public function index(){
      ...
      */
      ...
      $result['error']=''; //出错代码, 成为时为0,非0表示出错, 图片不插入
      ...
      $path = Doo::conf()->IMG_PATH.$spath.'/';
      $size = Doo::conf()->IMG_SIZES;
      ...
      $imgurl = Doo::conf()->IMG_URL.$spath.str_replace('src', '500x500', $imgpath);
      $result['url'] = $imgurl;
      echo json_encode($result);
    }
