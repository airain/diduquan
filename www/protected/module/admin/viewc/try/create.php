...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="col-md-12">
	      	  <h5 class=""><?php echo $module_name;?>创建 <i class="text-text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>管理" class="glyphicon glyphglyphicon glyphicon-plus-sign" href="/admin/try/index" ></a></h5>
			  <form method="POST" class="form-horizontal form-pos j_validate j_add"  role="form">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  	<textarea cols="70" placeholder="产品详细信息" rows="5" name="content" id="content"></textarea>
				  </div>
				</div>
				<div class="form-group">
