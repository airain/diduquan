...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="span12">
	      	  <h5 class=""><?php echo $module_name;?>编辑 <i class="text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>管理" class="glyphicon glyphglyphicon glyphicon-plus-sign" href="/admin/activity/index" ></a></h5>
