...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="col-md-12">
	      	  <h5 class=""><?php echo $module_name;?>添加 <i class="text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>管理" class="glyphicon glyphglyphicon glyphicon-plus-sign" href="/admin/user/index" ></a></h5>
			  <form method="POST" class="form-horizontal form-pos j_validate j_add">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				    <input type="text" placeholder="密码"  name="password" value="<?php echo $item->password;?>" />
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label" >淘宝ID</label>
				  <div class="col-sm-10">
				    <input type="text" placeholder="淘宝ID"  name="tao_uid" value="0" />
				  </div>
				</div>
				<div class="form-group">
				  <label class="col-sm-2 control-label" >用户状态</label>
				  <div class="col-sm-10">
				    <input type="text" placeholder="用户状态"  name="state" value="1" />
				  </div>
				</div>
