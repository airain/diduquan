	...
	<table class="table table-striped table-bordered table-hover table-condensed">
                  <thead>
                      <tr>
                          ...
                          <th>ID</th><th>类型</th><th>亲昵</th><th>Email</th><th>手机号</th><th>淘宝ID</th><th>登录时间</th><th>登录IP</th><th>用户状态</th><th>创建者</th><th>创建时间</th>
	                  ...
	                  <?php foreach($list as $k => $v){?>
	                  	<tr did="<?php echo $v['id'];?>">
                  		  <td><input type="checkbox" value="<?php echo $v['id'];?>"></td>
									...
									<td><?php echo $v['tao_uid'];?></td>
									<td><?php echo time_format($v['last_time']);?></td>
									<td><?php echo $v['last_ip'];?></td>
									<td><?php echo $v['state'];?></td>
									<td><?php echo $v['maker'];?></td>
									<td><?php echo time_format($v['mktime']);?></td>

                          <td>
                          	<a class="j_edit" href="/admin/user/update?id=<?php echo $v['id'];?>">编辑</a>
