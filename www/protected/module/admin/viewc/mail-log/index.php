...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="col-md-12">
	      		<h5 class=""><?php echo $module_name;?>管理 <i class="text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>添加" class="glyphicon glyphicon-plus-sign" href="/admin/maillog/create" ></a></h5>
