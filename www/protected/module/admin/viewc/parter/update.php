...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="col-md-12">
	      	  <h5 class=""><?php echo $module_name;?>编辑 <i class="text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>管理" class="glyphicon glyphglyphicon glyphicon-plus-sign" href="/admin/parter/index" ></a></h5>
			  <form method="POST" class="form-horizontal form-pos j_validate j_add">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  	...
				  	<div id="showImgBox"><img id="showImg" width="100" src="<?php echo getImgUrl($item->logo); ?>"/></div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
				  	<?php getCompanyType(array('id'=>'type', 'type'=>'select', 'checked'=>$item->type)); ?>
