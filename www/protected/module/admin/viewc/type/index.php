...
<div class="container-fluid">
    <div class="row">
	      <div id="main"  class="col-md-12">
	      		<h5 class=""><?php echo $module_name;?>管理 <i class="text-muted">|</i> <a data-placement="bottom"  title="<?php echo $module_name;?>添加" class="glyphicon glyphicon-plus-sign" href="/admin/type/create" ></a></h5>
	      		<div data-widget="navfixed" data-widget-config='{}'  class="j_subnav" style="overflow: hidden;">
		      		<form class="j_search nav well form-search">
		      			<ul class="list-unstyled list-inline">
							...
							<li> <a class="btn btn-link m_cr_conf" href="javascript:;">更新配置</a></li>
						</ul>
					</form>
				</div>
