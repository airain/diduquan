...
class EmailUnsubscribeController extends ModuleController{
	
	public function beforeRun($resource, $action){
		parent::beforeRun($resource, $action);
		$this->vdata['module_name'] = "邮件退订";
	}
    ...
    public function update(){
    	...
    	if($submit){
    		...
    		$this->vdata['script'] = 'admin/emailunsubscribe/create';
