...
$_SERVER['HTTP_HOST'] = "http://tbk.com";
$_SERVER['REQUEST_METHOD'] = 'GET';
// $_SERVER['REQUEST_URI'] = trim($uri);

include ROOT_PATH.'/protected/config/common.conf.php';

//修补配置
$config['SITE_PATH'] = ROOT_PATH."/";
...
// include ROOT_PATH.'/protected/config/routes.conf.php';
include ROOT_PATH.'/protected/config/db.conf.php';
// include ROOT_PATH.'/protected/config/top.conf.php';
