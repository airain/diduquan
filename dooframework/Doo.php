...
class Doo{
    ...
    public static function loadService($class_name, $createObj=FALSE){
    	return self::load($class_name, self::conf()->SITE_PATH . Doo::conf()->PROTECTED_FOLDER . "service/", $createObj);
    }
    ...
    public static function loadServiceAt($class_name, $moduleFolder=Null, $createObj=FALSE){
    	if($moduleFolder===null){
    		$moduleFolder = Doo::getAppPath();
    	}else{
    		$moduleFolder = Doo::getAppPath() . 'module/' . $moduleFolder;
    	}
    	return self::load($class_name, $moduleFolder. "/service/", $createObj);
    }
        ...
        if(isset($class[$classname]))
            ...
            if(empty(Doo::conf()->AUTOLOAD)===false){
            	...
            	if(!Doo::$auto_file){
            		...
            		if(Doo::conf()->APP_MODE=='dev' || !$rsExisting){
